                ...
                <div id="register-column" class="col">
                    ...
                    <div id="password-validation" style="display:none;">
                        <div id="length-validation"> 
                            <img id="incorrect-1" src="images/incorrect.png"></img>
                            <img id="correct-1" src="images/correct.png" style="display:none"></img>
                            <div id="length">Password must contain at least 8 characters.</div>
                        </div>
                        <div id="case-validation"> 
                            <img id="incorrect-2" src="images/incorrect.png"></img>
                            <img id="correct-2" src="images/correct.png" style="display:none"></img>
