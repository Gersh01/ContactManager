                ...
                <div id="contact-table">
                    ...
                    <div class="table">
                        <div id="contact-row-top" class="cell-top">
                            ...
                            <div id="contact-edit" class="cell text-black icon-cell">Edit</div>
                            <div id="contact-delete" class="cell text-black icon-cell">Delete</div>
                        </div>
                        <div id="contact-row-01" class="cell">
                            ...
                            <div id="contact-edit-1" class="cell text-black icon-cell" type="button">Edit</div>
                            <a id="contact-delete-1" href="javascript:deleteContact(1)" class="text-black a-link"><div id="deteleButton" class="cell text-black icon-cell" type="button">Delete</div></a>
                        </div>
                        <div id="contact-row-02" class="cell">
                            ...
                            <div id="contact-edit-2" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-222" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-03" class="cell">
                            ...
                            <div id="contact-edit-3" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-3" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-04" class="cell">
                            ...
                            <div id="contact-edit-4" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-4" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-05" class="cell">
                            ...
                            <div id="contact-edit-5" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-5" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-06" class="cell">
                            ...
                            <div id="contact-edit-6" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-6" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-07" class="cell">
                            ...
                            <div id="contact-edit-7" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-7" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-08" class="cell">
                            ...
                            <div id="contact-edit-8" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-8" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-09" class="cell">
                            ...
                            <div id="contact-edit-9" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-9" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                        <div id="contact-row-10" class="cell">
                            ...
                            <div id="contact-edit-10" class="cell text-black icon-cell" type="button">Edit</div>
                            <div id="contact-delete-10" class="cell text-black icon-cell" type="button">Delete</div>
                        </div>
                    </div>
                </div>
