...
<html lang="en">
    ...
    <body>
        <header id="nav-header" class="text-black nav py-5 bg-accent"> 
            ...
            <a id="about-us_button" href="javascript:doLogout()"> <div id="about-us-button" class="a-link button" type="button">Logout</div></a>
                ...
                <div id="contact-table">
                    ...
                    <div class="text-center my-6">
                        <div id="search-bar-row" class="search-bar row-alt">
                            ...
                            <a id="refresh-button" href="javascript:firstPage()" class="text-black a-link-alt"><div id="refreshButton" class="text-black refresh-page" type="button">Refresh</div></a>
                        </div>
                    </div>
