        ...
        <div class="py-6 bg-image-full" style="background-image: url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/5236376f-305d-42da-8e2d-48455360a090/ddzsehq-da9525d2-37e0-448f-aa49-a7274ba68387.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..nDVDNj0rk3vuQHD7DawjvowvIEn_70NADgE8MevlAOM')">
            ...
            <div class="container">
                ...
                <div id="page-selector" class="row">
                    <input id="refresh-button" class="refresh-page button" type="button">Refresh</div>
                    <input id="back-button" class="move-page button" type="button">Previous</div>
                    <input id="forward-button" class="move-page button" type="button">Next</div>
                </div>
            </div>
        </div>
